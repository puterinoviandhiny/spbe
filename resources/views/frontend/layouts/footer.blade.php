<footer class="footer_area footer_p_top f_bg_color">
    <img class="p_absolute leaf" src="{{ asset('frontend/img/v.svg') }}" alt="">
    <img class="p_absolute f_man wow fadeInLeft" data-wow-delay="0.4s" src="{{ asset('frontend/img/home_two/f_man.png') }}" alt="">
    <img class="p_absolute f_cloud" src="{{ asset('frontend/img/home_two/cloud.png') }}" alt="">
    <img class="p_absolute f_email" src="{{ asset('frontend/img/home_two/email-icon.png') }}" alt="">
    <img class="p_absolute f_email_two" src="{{ asset('frontend/img/home_two/email-icon_two.png') }}" alt="">
    <img class="p_absolute f_man_two wow fadeInLeft" data-wow-delay="0.2s" src="{{ asset('frontend/img/home_two/man.png') }}" alt="">
